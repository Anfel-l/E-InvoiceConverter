...
class PdfFileSignature(aspose.pdf.facades.SaveableFacade):
    ...
    def set_certificate(self, pfx: str, pass: str) -> None:
        '''Set certificate file and password for signing routine.
        
        :param pfx: PKCS #12 certificate file.
        :param pass: Password to get access for the certificate private key.'''
        ...
...
class PdfViewer:
    ...
    @overload
    def print_large_pdf(self, file_path: str, printer_settings: aspose.pydrawing.Printing.PrinterSettings) -> None:
    ...
    @overload
    def print_large_pdf(self, input_stream: Any, printer_settings: aspose.pydrawing.Printing.PrinterSettings) -> None:
    ...
    @overload
    def print_large_pdf(self, file_path: str, page_settings: aspose.pydrawing.Printing.PageSettings, printer_settings: aspose.pydrawing.Printing.PrinterSettings) -> None:
    ...
    @overload
    def print_large_pdf(self, input_stream: Any, page_settings: aspose.pydrawing.Printing.PageSettings, printer_settings: aspose.pydrawing.Printing.PrinterSettings) -> None:
    ...
    @overload
    def print_document_with_settings(self, page_settings: aspose.pydrawing.Printing.PageSettings, printer_settings: aspose.pydrawing.Printing.PrinterSettings) -> None:
    ...
    @overload
    def print_document_with_settings(self, printer_settings: aspose.pydrawing.Printing.PrinterSettings) -> None:
    ...
    def get_default_page_settings(self) -> aspose.pydrawing.Printing.PageSettings:
        '''Gets the default page settings.
        
        :returns: Page settings object.'''
        ...
    
    def get_default_printer_settings(self) -> aspose.pydrawing.Printing.PrinterSettings:
